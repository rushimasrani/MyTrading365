...
const TradeBookDialog: React.FC<TradeBookDialogProps> = ({ trades, onClose }) => {
  ...
  return (
    <div 
      className="fixed z-[90] font-sans select-none shadow-[0_0_20px_rgba(0,0,0,0.8)] border-l border-r border-b border-gray-600 bg-[#333] w-[1100px] h-[500px] flex flex-col"
